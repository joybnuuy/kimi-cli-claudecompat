"""Tests for Claude Code-compatible hook output features.

These test the extended HookResult fields (updated_input, system_message)
and the full JSON output parsing that Claude Code hooks produce.
"""
